/*This is my Arduino project on making diffent Siren Sound with their LED sync/transitions. You can get the this code from my Github 
...
void oneA() 
{//This function produces differnt transition on 1st siren.
...
void two() 
{ //This function produces the 2nd siren sound with progressive led transition.
...
void twoA() 
{ //This function produces differnt transition on 2nd siren.
...
void three() 
{              //This function produces the 3rd siren(AMBULANCE) sound with led transition.
  tone(buzz,440,200);
  delay(300);
...
void threeA() 
{              //This function produces differnt transition on 3rd siren.
  tone(buzz,440,200);
  delay(100);
  loopF(5,10,20);
  loopR(10,5,20);
...
void four() 
{                             //This function produces the 4th siren(POLICE) sound with led transition.
